...
class SchoolAdminController {
    ...
    async getAllSchoolAdmins(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            console.log(chalk.green("[School Admins] Get all school admins successfully"));
            sendSuccess(res, schoolAdmins, "Lấy danh sách school Admins thành công");
        } catch (error) {
            console.log(chalk.red("[School Admins] Error getting all school admins:", error))
            return next(error);
        }
    }
    ...
    async createSchoolAdmin(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            console.log(chalk.red("[School Admins] Error creatting school admin:", error))
            return next(error);
        }
    }
    ...
    async updateSchoolAdmin(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            console.log(chalk.red("[School Admins] Error updating school admin:", error))
            return next(error);
        }
    }
    ...
    async deleteSchoolAdmin(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            ...
            console.log(chalk.red("[School Admins] Error deletting school admin:", error))
            return next(error);
        }
    }
}
