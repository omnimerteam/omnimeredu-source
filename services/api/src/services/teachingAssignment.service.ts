...
class TeachingAssignmentService {
    ...
    async getTeachingAssignmentById(id: string, userId: string, userRole: string) {
        try {
    ...
    async createTeachingAssignment(assignmentData: Partial<ITeachingAssignment>, userId: string, userRole: string) {
        try {

            const assignment = await this.teachingAssignmentRepository.create(assignmentData);
            const classId = await this.classRepository.findById(assignment.classId.toString());
            const teacherId = await this.teacherRepository.findById(assignment.teacherId.toString());
    ...
    async updateTeachingAssignment(id: string, assignmentData: Partial<ITeachingAssignment>,
        ...
        try {
            ...
            const assignment = await this.teachingAssignmentRepository.update(id, assignmentData);
