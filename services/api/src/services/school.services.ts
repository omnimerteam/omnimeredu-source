...
class SchoolService {
    ...
    async getSchoolByNameOrCode(name: string, code: string, userId: string, userRole: string) {
        try {
            const schoolData = await this.schoolRepository.findByNameOrCode(name, code);
            if (!name && !code) {
    ...
    async createSchool(SchoolData: Partial<ISchool>, userId: string, userRole: string) {
        try {
    ...
    async updateSchool(id: string, SchoolData: Partial<ISchool>, userId: string, userRole: string) {
        try {
