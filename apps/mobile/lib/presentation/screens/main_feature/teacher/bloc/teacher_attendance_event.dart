...
class LoadAttendanceRecord extends TeacherAttendanceEvent {
  final DateTime date;
  final String classId;

  const LoadAttendanceRecord({required this.date, required this.classId});
