import 'data/datasources/remote/user/staff_remote_data_source.dart';
import 'data/repositories/user/staff_repository_impl.dart';
import 'data/repositories/user/teacher_repository_impl.dart';
import 'domain/repositories/user/staff_repository.dart';
...
import 'data/datasources/remote/school/attendance/attendance_remote_data_source.dart';
import 'data/datasources/remote/school/attendance/detail_record_remote_data_source.dart';
import 'data/datasources/remote/school/class/teaching_assignment_data_source.dart';
import 'data/datasources/remote/school/grade_remote_data_source.dart';
import 'data/datasources/remote/school/membership_request_data_source.dart';
import 'data/datasources/remote/school/tuition/extra_fee_remote_data_source.dart';
import 'data/datasources/remote/system/upload_remote_data_source.dart';
import 'data/datasources/remote/user/personnel_remote_data_source.dart';
import 'data/datasources/remote/user/school_admin_remote_data_source.dart';
import 'data/datasources/remote/user/student_remote_data_source.dart';
import 'data/datasources/remote/user/teacher_remote_data_source.dart';
import 'data/repositories/school/attendance/attendance_repository_impl.dart';
import 'data/repositories/school/attendance/detail_record_repository_impl.dart';
import 'data/repositories/school/class/teaching_assignment_impl.dart';
...
import 'data/repositories/school/tuition/extra_fee_repositoy_impl.dart';
import 'data/repositories/upload_repository_impl.dart';
import 'data/repositories/user/personnel_repository_impl.dart';
import 'data/repositories/user/school_admin_repository_impl.dart';
import 'data/repositories/user/student_repository_impl.dart';
...
import 'domain/repositories/school/tuition/extra_fee_repository.dart';
import 'domain/repositories/upload_repository.dart';
import 'domain/repositories/user/personnel_repository.dart';
import 'domain/repositories/user/school_admin_repository.dart';
import 'domain/repositories/user/student_repository.dart';
import 'domain/usecases/attendance/get_all_attendances_usecase.dart';
...
import 'domain/usecases/class/add_student_to_class_usecase.dart';
...
import 'domain/usecases/class/get_class_detail_view_by_id.dart';
import 'domain/usecases/class/remove_student_from_class_usecase.dart';
import 'domain/usecases/class/transfer_class_use_case.dart';
import 'domain/usecases/class/update_class_usecase.dart';
import 'domain/usecases/detail_record/get_attendance_record_by_id_usecase.dart';
import 'domain/usecases/detail_record/update_status_detail_record_usecase.dart';
import 'domain/usecases/extra_fee/create_extra_fee_usecase.dart';
import 'domain/usecases/extra_fee/delete_extra_fee_usecase.dart';
import 'domain/usecases/extra_fee/get_all_extra_fee_usecase.dart';
import 'domain/usecases/extra_fee/get_extra_fee_by_id_usecase.dart';
import 'domain/usecases/extra_fee/update_extra_fee_usecase.dart';
...
import 'domain/usecases/grade/get_grade_by_id_usecase.dart';
import 'domain/usecases/grade/get_grades_for_select_usecase.dart';
...
import 'domain/usecases/membership_request/delete_membership_request.dart';
import 'domain/usecases/membership_request/get_all_membership_request_usecase.dart';
...
import 'domain/usecases/personnel/dismiss_personnel_usecase.dart';
import 'domain/usecases/personnel/get_all_personnel_from_school_usecase.dart';
import 'domain/usecases/personnel/update_verified_usecase.dart';
import 'domain/usecases/school_admin/update_position_school_admin_usecase.dart';
...
import 'domain/usecases/teaching_assignment/create_teaching_assignment_usecase.dart';
import 'domain/usecases/teaching_assignment/delete_teaching_assignment_usecase.dart';
import 'domain/usecases/teaching_assignment/get_class_teacher_assignments_usecase.dart';
import 'domain/usecases/teaching_assignment/get_classes_teacher_assign_by_teacher_id_usecase.dart';
import 'domain/usecases/teaching_assignment/get_teaching_assignment_by_teacher_class_and_school_usecase.dart';
import 'domain/usecases/teaching_assignment/update_teaching_assignment_usecase.dart';
...
import 'presentation/screens/common/class_member_dialog/bloc/class_member_bloc.dart';
import 'presentation/screens/common/student_selector/cubit/student_selector_cubit.dart';
import 'presentation/screens/dashboard/teacher/cubit/teacher_classes_cubit.dart';
import 'presentation/screens/main_feature/teacher/bloc/teacher_attendance_bloc.dart';
